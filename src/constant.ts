...
export const weeklyPlans = [
  {
    name: 'Snelle resultaten & flexibiliteit',
    img: barChart12,
  },
  {
    name: 'Totaal: 630–2520 punten',
    img: coinsStacked02,
  },
  {
    name: '+60 tot +250 bonuspunten',
    img: award03,
  },
];
export const monthlyPlans = [
  ...
  {
    name: 'Totaal: 1260–5040 punten',
    img: coinsStacked02,
  },
  {
    name: '+120 tot +500 bonuspunten',
    img: award03,
  },
];
...
export const subcriptionBadges = [
  ...
  {
    name: 'Punten worden elke maandag toegevoegd',
    icon: clockRewind,
  },
  {
    name: 'Kies je maaltijden vóór zondag 23:59',
    icon: noodles,
  },
  {
    name: 'Annuleer of upgrade wanneer je wilt',
    icon: target04,
  },
];
...
export const HomeIntroProducts = [
  {
    id: 1,
    title1: 'KIES JE MAALTIJDEN',
    title2: 'OF KIES EEN PLAN',
    icon: CurrencyDollar,
    height: 342,
    img: require('public/images/home/intro-products/p1.png'),
    description: 'Elke week een menu met 30+ opties.',
    endTitle1: 'MINDER BETALEN, MEER KRIJGEN.',
    endTitle2: 'PAUZEER WANNEER JE WILT.',
    top: -65,
    width: '100%',
    left: 'auto',
    right: 0,
    headerTitle: 'HOE HET WERKT',
  },
  {
    headerTitle: 'HOE HET WERKT',
    id: 2,
    title1: 'VERS BEREID DOOR',
    title2: ' ONZE CHEFS',
    height: 265,
    icon: Target04,
    img: require('public/images/home/intro-products/p2.png'),
    description: 'Wij doen het voorbereidende werk. Jij hoeft alleen nog te genieten.',
    endTitle1: 'AFGESTEMD OP JOUW ',
    endTitle2: 'SMAAK EN LEVENSSTIJL',
    width: 300,
    top: -80,
    right: 0,
  ...
  },
  {
    ...
    id: 3,
    height: 270,
    title1: 'OPWARMEN, ETEN ',
    title2: '& GAAN',
    icon: ChefHat,
    description: 'Geen voorbereiding. Geen gedoe. Binnen een paar minuten klaar om te eten.',
    img: require('public/images/home/intro-products/p3.png'),
    endTitle1: 'MAALTIJDEN MET ZORG ',
    endTitle2: 'SAMENGESTELD',
    width: 390,
    top: -80,
    right: -38,
    left: 'auto',
